...
with open('export/'+'data.csv', 'a+', newline='', encoding='utf-8-sig') as csvFile:
        ...
        if response.ok:
            ...
            for h3 in soup.findAll('h3'):
                ...
                if response.ok:
                    ...
                    writer.writerow([urlLinks, code, title, priceNet, priceBrut, stock, description, category, review,
                                     imageLinks])
